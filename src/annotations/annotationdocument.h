...
Q_SIGNALS:
    /*!
     * \qmlsignal AnnotationDocument::selectedItemWrapperChanged()
     */
    void selectedItemWrapperChanged();
    /*!
     * \qmlsignal AnnotationDocument::undoStackDepthChanged()
     */
    void undoStackDepthChanged();
    /*!
     * \qmlsignal AnnotationDocument::redoStackDepthChanged()
     */
    void redoStackDepthChanged();
    /*!
     * \qmlsignal AnnotationDocument::canvasRectChanged()
     */
    void canvasRectChanged();
    /*!
     * \qmlsignal AnnotationDocument::imageSizeChanged()
     */
    void imageSizeChanged();
    /*!
     * \qmlsignal AnnotationDocument::imageDprChanged()
     */
    void imageDprChanged();
    /*!
     * \qmlsignal AnnotationDocument::transformChanged()
     */
    void transformChanged();
    /*!
     * \qmlsignal AnnotationDocument::modifiedChanged()
     */
    void modifiedChanged();

    /*!
     * \qmlsignal AnnotationDocument::repaintNeeded(RepaintType types)
     */
