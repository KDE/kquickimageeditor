...
// Replicates the behavior of cv::GaussianBlur with automatic kernel size.
inline void stackBlur(cv::InputArray &in, cv::OutputArray &out, cv::Size ksize, double sigmaX, double sigmaY = 0)
{
